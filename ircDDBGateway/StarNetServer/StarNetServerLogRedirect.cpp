...
void CStarNetServerLogRedirect::DoLog(wxLogLevel level, const wxChar* msg, time_t timestamp)
{
	wxASSERT(msg != NULL);
...
void CStarNetServerLogRedirect::DoLogString(const wxChar* msg, time_t)
{
	wxASSERT(msg != NULL);
