...
CIRCDDBGatewayLogRedirect::CIRCDDBGatewayLogRedirect() :
wxLog()
{
}
...
void CIRCDDBGatewayLogRedirect::DoLog(wxLogLevel level, const wxChar* msg, time_t timestamp)
{
	wxASSERT(msg != NULL);
...
void CIRCDDBGatewayLogRedirect::DoLogString(const wxChar* msg, time_t)
{
	wxASSERT(msg != NULL);
