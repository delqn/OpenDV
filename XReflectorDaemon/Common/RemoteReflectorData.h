...
#ifndef	RemoteReflectorData_H
#define	RemoteReflectorData_H
...
class CRemoteReflectorData {
public:
	CRemoteReflectorData(const wxString& callsign, RECONNECT reconnect, const wxString& reflector);
	~CRemoteReflectorData();
