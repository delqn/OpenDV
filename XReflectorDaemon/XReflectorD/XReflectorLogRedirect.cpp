...
CXReflectorLogRedirect::CXReflectorLogRedirect() :
wxLog()
{
}
...
void CXReflectorLogRedirect::DoLog(wxLogLevel level, const wxChar* msg, time_t timestamp)
{
	wxASSERT(msg != NULL);
...
void CXReflectorLogRedirect::DoLogString(const wxChar* msg, time_t timestamp)
{
	wxASSERT(msg != NULL);
