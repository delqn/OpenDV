...
#ifndef	DVToolWriterDefs_H
#define	DVToolWriterDefs_H
...
const unsigned int LABEL_WIDTH   = 60U;
const unsigned int CONTROL_WIDTH = 100U;
const unsigned int MIC_WIDTH     = 30U;
...
const wxString LOG_FILE_NAME    = wxT("DVToolWriter");
