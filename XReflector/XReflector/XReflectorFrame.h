...
#ifndef	XReflectorFrame_H
#define	XReflectorFrame_H
...
class CXReflectorFrame : public wxFrame {
public:
	CXReflectorFrame(const wxString& title, const wxPoint& position, bool gui);
	virtual ~CXReflectorFrame();
