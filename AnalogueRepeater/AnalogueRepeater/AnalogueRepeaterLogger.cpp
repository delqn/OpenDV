/*
 *   Copyright (C) 2002,2003,2009-2010,2012,2013 by Jonathan Naylor G4KLX
 *
...
CAnalogueRepeaterLogger::CAnalogueRepeaterLogger() :
wxLog()
{
}
...
void CAnalogueRepeaterLogger::DoLog(wxLogLevel level, const wxChar* msg, time_t timestamp)
{
	wxASSERT(msg != NULL);
...
void CAnalogueRepeaterLogger::DoLogString(const wxChar* msg, time_t)
{
	wxASSERT(msg != NULL);
