...
#ifndef	DExtraGatewayAudioUnit_H
#define	DExtraGatewayAudioUnit_H
...
class CDExtraGatewayAudioUnit {
public:
	CDExtraGatewayAudioUnit(IDExtraGatewayCallback* handler, const wxString& callsign);
	~CDExtraGatewayAudioUnit();
