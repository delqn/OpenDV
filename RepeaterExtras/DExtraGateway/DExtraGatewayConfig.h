...
#ifndef	DExtraGatewayConfig_H
#define	DExtraGatewayConfig_H
...
class CDExtraGatewayConfig {
public:
#if defined(__WINDOWS__)
	CDExtraGatewayConfig(wxConfigBase* config, const wxString& name);
#else
	CDExtraGatewayConfig(const wxString& dir, const wxString& name);
#endif
	~CDExtraGatewayConfig();
