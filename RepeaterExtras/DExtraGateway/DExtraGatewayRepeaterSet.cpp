...
CDExtraGatewayRepeaterSet::CDExtraGatewayRepeaterSet(wxWindow* parent, int id, const wxString& title, const wxString& repeaterCallsign, const wxString& repeaterAddress, unsigned int repeaterPort, const wxString& localAddress, unsigned int localPort) :
wxPanel(parent, id),
m_title(title),
...
CDExtraGatewayRepeaterSet::~CDExtraGatewayRepeaterSet()
{
}
...
wxString CDExtraGatewayRepeaterSet::getRepeaterCallsign() const
{
	return m_repeaterCallsign->GetValue();
}

wxString CDExtraGatewayRepeaterSet::getRepeaterAddress() const
{
	return m_repeaterAddress->GetValue();
}

unsigned int CDExtraGatewayRepeaterSet::getRepeaterPort() const
{
	unsigned long n;
...
wxString CDExtraGatewayRepeaterSet::getLocalAddress() const
{
	return m_localAddress->GetValue();
}

unsigned int CDExtraGatewayRepeaterSet::getLocalPort() const
{
	unsigned long n;
