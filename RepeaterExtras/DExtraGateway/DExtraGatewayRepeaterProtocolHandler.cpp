...
CDExtraGatewayRepeaterProtocolHandler::CDExtraGatewayRepeaterProtocolHandler(const wxString& repeaterAddress, unsigned int repeaterPort, const wxString& localAddress, unsigned int localPort) :
...
CDExtraGatewayRepeaterProtocolHandler::~CDExtraGatewayRepeaterProtocolHandler()
{
	delete[] m_buffer;
}

bool CDExtraGatewayRepeaterProtocolHandler::open()
{
	return m_socket.open();
}

bool CDExtraGatewayRepeaterProtocolHandler::writeHeader(const CDExtraGatewayHeaderData& header)
{
...
bool CDExtraGatewayRepeaterProtocolHandler::writeData(const CDExtraGatewayAMBEData& data)
{
...
REPEATER_TYPE CDExtraGatewayRepeaterProtocolHandler::read()
{
	bool res = true;
...
bool CDExtraGatewayRepeaterProtocolHandler::readPackets()
{
	m_type = RT_NONE;
...
CDExtraGatewayHeaderData* CDExtraGatewayRepeaterProtocolHandler::readHeader()
{
	if (m_type != RT_HEADER)
		return NULL;
...
CDExtraGatewayAMBEData* CDExtraGatewayRepeaterProtocolHandler::readData()
{
	if (m_type != RT_DATA)
		return NULL;
...
void CDExtraGatewayRepeaterProtocolHandler::close()
{
	m_socket.close();
}
