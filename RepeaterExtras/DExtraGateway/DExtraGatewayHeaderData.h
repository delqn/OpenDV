...
#ifndef	DExtraGatewayHeaderData_H
#define	DExtraGatewayHeaderData_H

#include <wx/wx.h>

class CDExtraGatewayHeaderData {
public:
	CDExtraGatewayHeaderData();
	CDExtraGatewayHeaderData(const CDExtraGatewayHeaderData& header);
	~CDExtraGatewayHeaderData();

	bool setRepeaterData(const unsigned char* data, unsigned int length, bool check);
	bool setDExtraData(const unsigned char* data, unsigned int length, bool check);
