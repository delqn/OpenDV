...
#ifndef	DExtraGatewayRepeaterSet_H
#define	DExtraGatewayRepeaterSet_H
...
class CDExtraGatewayRepeaterSet : public wxPanel {
public:
	CDExtraGatewayRepeaterSet(wxWindow* parent, int id, const wxString& title, const wxString& repeaterCallsign, const wxString& repeaterAddress, unsigned int repeaterPort, const wxString& localAddress, unsigned int localPort);
	virtual ~CDExtraGatewayRepeaterSet();
