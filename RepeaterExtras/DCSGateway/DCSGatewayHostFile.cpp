...
CDCSGatewayHostFile::CDCSGatewayHostFile(const wxString& fileName) :
m_names(),
m_hosts()
{
...
CDCSGatewayHostFile::~CDCSGatewayHostFile()
{
}

unsigned int CDCSGatewayHostFile::getCount() const
{
	return m_hosts.GetCount();
}

wxString CDCSGatewayHostFile::getName(unsigned int n) const
{
	return m_names.Item(n);
}

wxString CDCSGatewayHostFile::getHost(unsigned int n) const
{
	return m_hosts.Item(n);
}

wxArrayString CDCSGatewayHostFile::getNames() const
{
	return m_names;
}

wxArrayString CDCSGatewayHostFile::getHosts() const
{
	return m_hosts;
}
