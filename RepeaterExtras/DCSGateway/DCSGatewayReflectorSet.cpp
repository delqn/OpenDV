...
#include "DCSGatewayReflectorSet.h"
...
m_language(NULL)
{
	...
	CDCSGatewayHostFile file(fileName.GetFullPath());
...
CDCSGatewayReflectorSet::~CDCSGatewayReflectorSet()
{
}

bool CDCSGatewayReflectorSet::Validate()
{
...
bool CDCSGatewayReflectorSet::atStartup() const
{
...
TEXT_LANG CDCSGatewayReflectorSet::getLanguage() const
{
