...
CDCSGatewayConfig::CDCSGatewayConfig(wxConfigBase* config, const wxString& name) :
m_config(config),
m_name(wxT("/")),
...
CDCSGatewayConfig::~CDCSGatewayConfig()
{
	delete m_config;
}
...
void CDCSGatewayConfig::getRepeater(wxString& repeaterCallsign, wxString& repeaterAddress, unsigned int& repeaterPort, wxString& localAddress, unsigned int& localPort) const
{
...
void CDCSGatewayConfig::setRepeater(const wxString& repeaterCallsign, const wxString& repeaterAddress, unsigned int repeaterPort, const wxString& localAddress, unsigned int localPort)
{
...
void CDCSGatewayConfig::getPosition(int& x, int& y) const
{
	x = m_x;
	y = m_y;
}

void CDCSGatewayConfig::setPosition(int x, int y)
{
	m_x = x;
	m_y = y;
}
